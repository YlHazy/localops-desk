...
- The Watch Settings (`值守设置`) page turns those distributed controls into one three-stage daily-watch relay: evidence source, automatic rhythm, and native desktop attention. It names the next missing layer without claiming that a browser preview is a desktop notification channel.
