...
const smokeApiToken = randomBytes(32).toString("base64url");

const child = spawn(executable, ["--smoke-check"], {
  cwd: root,
  env: { ...process.env, LOCALOPS_API_TOKEN: smokeApiToken, LOCALOPS_SMOKE_REPORT: reportPath, LOCALOPS_SMOKE_PROFILE: profilePath, LOCALOPS_SMOKE_API_PORT: String(smokePort) },
  windowsHide: true,
