...
export function watchModeCopy(options: { supported: boolean; blocked: boolean; enabled: boolean; quietUntil?: number; now?: number }): { label: string; detail: string; state: "unsupported" | "blocked" | "off" | "quiet" | "active" };
